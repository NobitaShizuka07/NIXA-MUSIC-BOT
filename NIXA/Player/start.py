...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            [
                InlineKeyboardButton("👮 ᴏᴡɴᴇʀ", url="https://t.me/Nobita_Ki_Duniya"),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("♨️ sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="Lol🤧🤧"),
            ],
            [
...
async def start(client: Client, message: Message):
    ...
    buttons =  [
            ...
            [
                InlineKeyboardButton("👥 sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{GROUP_SUPPORT}"),
                InlineKeyboardButton("📢 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/NOBITA_VC"),
            ],
            [
                InlineKeyboardButton("♨️ sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="LOL🤧🤧"),
            ],
